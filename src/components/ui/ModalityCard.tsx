...
export default function ModalityCard({ 
  ...
  return (
    <div className="relative">
      <Card 
        className="bg-gray-900 border-gray-700 p-6 text-center hover-card cursor-pointer transition-all duration-300 h-full"
      ...
      >
        ...
        <div className={`absolute left-0 right-0 top-full mt-2 z-10 transition-all duration-300 ${
